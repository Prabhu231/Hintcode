...
import HouseRobberTestCase from "../../Database/Schemas/HouseRobberSchema";
...
const runTestsForHouseRobber = async (cppFunction: string) => {
  try {
    await connectDB();

    const testCases = await HouseRobberTestCase.find();
...
export default runTestsForHouseRobber;
